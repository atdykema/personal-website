/*this terraform file would build the infrastructure for my personal website via s3 bucket and 
Route 53 although this file is not currently used in production
*/
...
/*
Plans for CloudFront in future
*/
